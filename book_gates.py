...
if len(_vec) != 189:
    bad.append(f'COVERAGE: {len(_vec)} true-vector .svg walked, expected 189 — a file was '
...
if _ngraphic != 79:
    bad.append(f'COVERAGE: {_ngraphic} GRAPHIC_ vector files walked, expected 79 — the label '
