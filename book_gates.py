...
if len(_vec) != 186:
    bad.append(f'COVERAGE: {len(_vec)} true-vector .svg walked, expected 186 — a file was '
...
if _ngraphic != 76:
    bad.append(f'COVERAGE: {_ngraphic} GRAPHIC_ vector files walked, expected 76 — the label '
