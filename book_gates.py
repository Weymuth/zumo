...
if len(_vec) != 194:
    bad.append(f'COVERAGE: {len(_vec)} true-vector .svg walked, expected 194 — a file was '
...
if _ngraphic != 83:
    bad.append(f'COVERAGE: {_ngraphic} GRAPHIC_ vector files walked, expected 83 — the label '
