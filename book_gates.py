...
if len(_vec) != 187:
    bad.append(f'COVERAGE: {len(_vec)} true-vector .svg walked, expected 187 — a file was '
...
if _ngraphic != 77:
    bad.append(f'COVERAGE: {_ngraphic} GRAPHIC_ vector files walked, expected 77 — the label '
