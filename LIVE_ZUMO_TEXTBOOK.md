...
**Date:** July 25, 2026 (Session 73 — **L02'S RENUMBER IS CUT**. The lesson that never fit the skeleton now fits it: §4 Hardware · §5 The Code · §6 Build It, "Make It Yours" folded into §9, §3 closed to 3.1–3.6. **L02 v02.16.0 → v03.0.0**, the book's first major re-baseline.)
**Status:** **THE OUTLIER IS GONE.** L02 had carried the code walkthrough inside §3, prep at §4, the build at §5, and a unique §6 "Make It Yours" that pushed every later number one ahead — for the life of the book. §3.2 *Understanding Each Section* lifted out as ONE contiguous 29,833-character block (exactly the S72 measurement) and became **§5 The Code**; nothing needed reordering. Old §5 → §6 with *Getting Ready* folded into its opening, so the line "your fresh copy is open and healthy — let's build" still lands immediately before STEP 1. **Zero nav-pill edits were needed** — the strip already read "4. Hardware · 5. Code · 6. Build", the same L01 story from S72: the file already believed canon and only the visible banners had drifted. Two corrections to the S72 plan. First, **§3 closes to 3.1–3.6, not 3.1–3.5** — `3.2d` is its own `<h3>`, not nested inside `3.2c` as the plan suspected, so six subsections survive the lift. Second, **the citation trap was worse than logged**: all 15 renumber-affected references were re-pointed by hand, then machine-checked against where the answer content actually lives, and BC01 item 3 ("what is a function prototype?") turned out to cite **§3.2, which never taught prototypes** — 9 hits in §3.1, 8 in the build steps, zero in the lifted block. That citation was already wrong when it shipped in S72; the renumber would have converted a wrong pointer into a different wrong pointer, green all the way. Re-pointed to (§3.1, §6 Step 7). **Bible v8.58.1** records the rule that falls out of it: a §-citation is verified by checking the cited section CONTAINS the answer, never by checking that one is present — which is all the §25.2 gate can do. **"Make It Yours" landed as prose, de-duped**: per §6.12a open-creative content takes prose, not three panels, and two of its four options were already full §9 challenge cards (Press Counter ≡ Challenge 3 Button Counter; Secret Screen ≈ Challenge 5 Master Reset Combo). DJ ruled drop the duplicates; Add Color and Animated Welcome survive as a prose block at the end of §9, ahead of the CODE SWAP, which stays last per the S72 ruling.

**Versions:** L01 **v03.10.0** · L02 **v03.0.0** · L03 **v03.13.2** · L04 **v04.6.2** · L05 **v04.8.2** · L06 **v04.11.2** · L07 **v04.7.2** · L08 **v04.6.2** · L09 **v05.4.2** · L10 **v02.5.2** · L11 **v02.7.2** · L12 **v01.7.2** · L13 **v02.6.2** · L14 **v02.8.2** · L15 **v02.6.2** · L16 **v02.5.2** · Bible **v8.58.1** · Maker **v2.45.1** · Gate v1.6 · Harness v3.0 · pill_sweep v1.0 · book_gates **v1.7 (21 gates)** · going_deeper **v01.1.0** · **web tools (version-lined in-file): timer v1.3.0 · Maker v2.45.1 · tutor v1.0.0 · index v1.3.0**.
