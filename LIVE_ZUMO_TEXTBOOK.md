...
**Date:** July 16, 2026 (Session 46 — L03 BOOK TASKS DONE + PUSHED & LIVE. Added modulo `%` explainer (blue callout) to the C05 Variable Speed card + two Coach's Tips at Step 13 (upload/power-on: setup() runs once, put robot down before upload completes; and: don't trust AI autocomplete, verify against the lesson). Task (a) "1000 ms = 1 second" was already present (line 766) — no change. L03 v03.4.3 → v03.4.4, hidden comment bumped, visible banner left at 03.4 (minor). Diff-audited: 4 changes, 0 deletions. Verified live by fresh clone, md5 matches staged. Prior: Session 45 close — L02/L03 CONTENT QUEUE DONE + C04 RAMP LEARNER-MODE, all PUSHED & LIVE (commit 35e81fd). Cleared the S44 remaining queue: (3) data-types explainer added to L02 §3.2b as a blue callout (int/bool/float/long/char, one line each) + int/bool deep prose; (4) constrain "two different jobs" amber callout on L03 C03; (5) USB-falsifies-readBatteryMillivolts() amber callout on L03 C02. Bible → v8.30 (§18.4 type-explainer callout canon + §18.3 chat-display rule). Learner mode C04 Ramp solved by DJ; surfaced the chat-display gap (Claude showed the raw payload body, not the generated file → missing #include). Prior: Session 44 — S43 reconciled, whole-template starters, Ramp Option C.)
**Status:** ✅ **S45 — L02/L03 CONTENT QUEUE DONE (data types · constrain two-jobs · USB-battery) + C04 RAMP LEARNER-MODE (ALL PUSHED & LIVE, commit 35e81fd)** · L01 v03.2.6 · L02 **v02.2.3** · L03 **v03.4.4** · L04 v04.0.8 · L05 v04.1.8 · L06 v04.5.7 · L07 v04.3.8 · L08 v04.1.6 · L09 v05.0.7 · L10 v02.1.10 · L11 v02.0.3 · L12 v01.0.3 · L13 v02.0.3 · L14 v02.1.1 · L15 v02.0.2 · L16 v02.0.1 *(L11–L16 = git-proven filename FLOOR; S35/S36 edited them without re-versioning, true ver ≥ floor — reconcile on next open)* · index.html **v1.2.1** · Bible **v8.31** · Maker **v2.30** · Gate **v1.3** · Harness **v3.0** · engine.py · ✅ **PUSHED & VERIFIED (fresh clone): all S45 content + the late-session pill sweep are live; md5 matches staged.** · 📖 **BIBLE v8.30 — §18.4 TYPE-EXPLAINER CALLOUT + §18.3 CHAT-DISPLAY RULE.** · ✅ **PILL SWEEP DONE: 39 pills L01/L02/L04–L10 recolored to §6.12 canon (MEDIUM→blue ×25, HARD→orange ×14) + C06 re-rated →EASY. Labels unchanged, diff-audited.** · ⚠️ **STILL QUEUED: 4 EXPERT pills (L04/L06/L09/L10) need per-card ADVANCED-vs-TOUGH ruling · C06 reorder to #1 · book-wide whole-template starters for L08/L09/L10 (currently ref `finished`)**
**Currently working on:** ✅ **S46 — L03 BOOK TASKS DONE (modulo explainer + 2 Coach's Tips), PUSHED & LIVE (L03 v03.4.4).** Next queued: **C06 reorder to #1** (coordinated L03 edit, bumps L03) · **4 EXPERT-pill ruling** (L04/L06/L09/L10, needs per-card ADVANCED-vs-TOUGH call) · whole-template starters (L08/L09/L10 + L03 C05/C06). **LEARNER MODE still pending: L03_C05 Variable Speed** (arrays + index + modulo — the modulo explainer is now in the card to support it). — Session 46 opened with S45 with S45 fully pushed & LIVE (L02 v02.2.2 · L03 v03.4.2 · L01 v03.2.5 · L04 v04.0.7 · L05 v04.1.7 · L06 v04.5.6 · L07 v04.3.7 · L08 v04.1.5 · L09 v05.0.6 · L10 v02.1.9 · Bible v8.30 — verify at open with a fresh clone). The late-session pill sweep (39 pills → §6.12 canon) + C06 re-rate (→EASY) bumped L01–L10. The **S44 content queue (items 3-5) is DONE**. **LEARNER MODE:** C02 Battery Warning ✅ · C03 Constrain ✅ · **C04 Ramp ✅** (DJ wrote it; hit setup-vs-loop + missing-#include — the chat-display rule came out of it, now Bible §18.3). **NEXT = L03_C05 Variable Speed** (arrays + cycling index — the hardest rung). ⚠️ **CHAT-DISPLAY RULE (new, Bible §18.3):** when showing a Maker starter in chat, PREPEND the wrapper header (`#include <Zumo32U4.h>` + MY PLAN) so it matches the generated file. **BENCH (need robot):** Q017 L09 six numbers · Q044 calibration-spin · Q046 gyro-bias · L02 §5 green-LED · Constrain RUN_MS duration. **QUEUED DEBT (own sessions):** book-wide pill sweep (~47 pills L01–L10) · book-wide whole-template starters for L08/L09/L10 (currently ref `finished`). **PARKED:** solution-disclosure · monetization/ebook · "Know Your Zumo" · AI Tutor (LAST).
...
> **Source of truth = `ZUMO_SUPER_BIBLE.md` (v8.31).** Filename is UNVERSIONED — the version lives ONLY in the internal line. Verify with `grep -oE "Bible version: v[0-9.]+"`.
