...
**Date:** July 17, 2026 (Session 48 — CHALLENGE-TEMPLATE TERM + LEARNING-MODE-FILE CANON. Two DJ rulings folded into durable canon: (1) Bible §19 NEW — the per-lesson learning-mode file convention (`ZUMO_LEARNMODE_LNN.md`, repo root; teacher-side teaching record + AI-Tutor source, NOT a payload source); L03's is live. (2) TERM: the §18.3 full-section-header starter is now named a **challenge template** project-wide; "scaffold" retired for THIS sense only (the §14 TDP-accumulation and §5 theory-build senses of "scaffold" are untouched). Coordinated rename: Bible §18.3/§19 + the two L03 Maker dropdown labels "(starter)"→"(challenge template)" (label text only; no `kind=` id, payload, or byte change). Lessons needed NO edit — their only "starter"/"scaffold" hits were the other senses. Bible v8.31→v8.32, Maker v2.30→v2.31. node --check clean on both Maker JS blocks; diff-audited. S47 (learner-mode only, C01–C06 walked, two staging files added) made NO file edits — first LIVE.md regen since S46. Prior: Session 46 — L03 book tasks (modulo explainer + 2 Coach's Tips, L03 v03.4.4) + EXPERT tier retired book-wide + §5b applied to all 16 lessons + L11–L16 true versions recovered and proven. Bible was v8.31.)
**Status:** ✅ **S48 — CHALLENGE-TEMPLATE TERM + LEARNING-MODE-FILE CANON (STAGED, not yet pushed)** · L01 v03.2.6 · L02 v02.2.3 · L03 **v03.4.4** · L04 v04.0.9 · L05 v04.1.8 · L06 v04.5.8 · L07 v04.3.8 · L08 v04.1.6 · L09 v05.0.8 · L10 v02.1.11 · L11 v02.2.1 · L12 v01.2.2 · L13 v02.2.1 · L14 v02.4.1 · L15 v02.2.2 · L16 v02.2.1 · index.html v1.2.1 · Bible **v8.32** · Maker **v2.31** · Gate v1.3 · Harness v3.0 · 📖 **BIBLE v8.32 — §19 PER-LESSON LEARNING-MODE FILE (NEW) + §18.3 "CHALLENGE TEMPLATE" TERM.** · ⚠️ **NOT YET PUSHED: Bible v8.32 + Maker v2.31. Push = repo (newproject.html — 5.09 MB, rename on disk NOT via web UI) + Bible + this LIVE.md. No SVGs, no lessons, no Canvas.**
**Currently working on:** ✅ **S48 CLOSE.** Both S48 rulings are canon. Files changed: Bible (§19 new, §18.3 term) + Maker (2 L03 labels, badge, changelog). **NEXT queued (unchanged):** the L03 challenge-template starter fix (C01/C05/C06 + L08/L09/L10 ref a `finished` payload that doesn't exist for L03 — lift the staged `ZUMO_L03_TEMPLATES.md` in as gate-verified whole-template payloads + correct card text; coordinated Maker+card edit, bumps L03+Maker) · C06 reorder to #1 · L03 prose (prototype explainer, 3 Coach's Tips, zero-index, scope) · Maker batch · L01 VS Code multi-root step. **LEARNER MODE pending: L03_C05 Variable Speed.** **BENCH (need robot):** Q017 L09 six numbers · Q044 calibration-spin · Q046 gyro-bias · L02 §5 green-LED · Constrain RUN_MS. **PARKED:** solution-disclosure · monetization/ebook · "Know Your Zumo" · AI Tutor (LAST). **Repo hygiene:** `README_S39_PUSH.md` — `git rm` when convenient; `ZUMO_L03_TEMPLATES.md` is STAGING, not a live payload source.
