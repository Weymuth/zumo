...
**Date:** July 27, 2026 (Session 85 — **THE DRIFT WAS HIDING A DISTINCTION**: the queue item was *"L13/L14 doubled 🕵️, one-line fix each"*; the bonus block turned out to be **three constructs wearing one name** — Practice 🔨 (write new code), Observation 🔍 (**nothing is broken**), Sabotage 🕵️ (someone else broke it) — and six emoji strata across fifteen lessons were concealing the difference. **§4.5 NEW, superseding the v8.14 S20 "Bonus" vocabulary canon**, which had named the block once and rejected "Extra Practice" outright. Generated in one pass: 14 banners, 14 nav pills, 6 prose links, 4 callouts, **21 card titles renamed *Mystery N* → *Experiment N*** and the 5 cross-references that would otherwise have pointed at names that no longer exist. **book_gates v1.17, 30 gates**, gate 30 control-run seven ways including the independence test. Bible **v8.72**, gates **30/30 PASS**.)
**Status:** **A CATEGORY A STUDENT MEETS ONCE IS NOT A CATEGORY.** The session's real question was not how many emoji but how many families, and the deciding argument was a harm one: collapsing Observation into Sabotage tells a student to hunt for a defect in L04–L06 where none exists, and they conclude they are bad at this rather than that there was nothing to find. Three families, each bound to a method, each named in words on the banner and the pill — the emoji is only a fast visual index. **L07 was the boundary case and it was settled by method, not vocabulary**: its own prose said *"Sabotage science"* and *"detective work"*, but it has zero Maker defect links and every card tells the student exactly what to change, so nothing is hidden and it is Observation; the prose was the thing that was wrong. **§24.6c fired twice, both against this session's own work**: a 12,000-character extraction window stopped inside the block and misreported L02/L03 as 5 and 4 cards when both hold six — the lessons' own *"six more"* callouts had been right all along — and L03's "Extra Practice" pill was reported as the prototype to follow when it is **the exact drift the S20 ruling was written to kill**, surviving in the one lesson that sweep missed. A live precedent is a lead too. One gate bug caught en route with the BOOK in the right: the placement regex demanded `</div>` at offset zero and L04/L05 have a newline there. **NOT verified: the rendered Pages site** (sandbox blocks weymuth.github.io) — this batch changes visible text in 14 lessons, and S84 batch 1's five moved banners still want an eyeball.

**Versions:** L01 **v03.10.4** · L02 **v03.1.0** · L03 **v03.15.0** · L04 **v04.9.0** · L05 **v04.11.0** · L06 **v04.13.0** · L07 **v04.9.0** · L08 **v04.8.0** · L09 **v05.6.0** · L10 **v02.6.0** · L11 **v02.8.0** · L12 **v01.9.0** · L13 **v02.8.0** · L14 **v02.10.0** · L15 **v02.7.0** · L16 **v02.5.4** · Bible **v8.72** · Maker **v2.45.1** · Gate v1.6 · Harness v3.0 · pill_sweep v1.0 · book_gates **v1.17 (30 gates)** · lesson_inventory v1.0.4 · **gen_bonus_banner v1.1** · going_deeper **v01.1.0** · **web tools (version-lined in-file): timer v1.3.0 · Maker v2.45.1 · tutor v1.0.0 · index v1.3.0**.
