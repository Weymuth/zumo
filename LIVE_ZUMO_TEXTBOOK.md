...
**Date:** July 25, 2026 (Session 72 — **L02 JOINS THE BRAIN CHECK FAMILY**, and the **ten-section skeleton became enforceable canon**: Bible §4.4, with L01 brought into conformance. L02's structural renumber is SPECIFIED AND MEASURED but NOT YET CUT.)
**Status:** **THE SKELETON HAS TEETH NOW.** The Core 10 list has named §4 Hardware and §5 Code since v8, but nothing enforced it, and two lessons had been off it for the life of the book without anyone noticing. **Bible §4.4 (new)** makes the skeleton mandatory and answers the question that actually caused the drift: what a lesson does when a section's job comes up thin. It appears and says so. Lesson-unique material folds into the nearest skeleton section rather than becoming a new numbered one, and DJ's proposal to stub every section everywhere with "does not apply" was **rejected on a pedagogy cost** — empty sections train students to skip headers, which is expensive in a course where the reading is the gate. §8A stays CONDITIONAL, re-ruled unchanged. **L01 v03.10.0** turned out to be nearly free: its nav pill already read "4. Hardware" and its HTML comment already read SECTION 4: HARDWARE SETUP — only the visible header had drifted to "Install the Tools", so the file already believed what canon says. Retitled, plus the *Meet Your Robot* block the slot owed, naming the three parts L01's code actually touches. No renumber; L01's §5 and §6 already matched. **L02's restructure is fully specified and measured but deliberately NOT cut this session** — see the plan file. The measurement found the good news (3.2 "Understanding Each Section", 29.8 KB, lifts out as ONE contiguous block, so nothing needs reordering) and the trap: **16 §-citations inside the Brain Check blocks written earlier this same session point at §3.2 and "§5 Step N", both of which the renumber moves** — and the §25.2 gate checks that a Mental item NAMES a §, not that it names the RIGHT one. A wrong citation would ship green. That is a silent-failure class worth its own session rather than the tail of this one.

**Versions:** L01 **v03.10.0** · L02 **v02.16.0** · L03 **v03.13.2** · L04 **v04.6.2** · L05 **v04.8.2** · L06 **v04.11.2** · L07 **v04.7.2** · L08 **v04.6.2** · L09 **v05.4.2** · L10 **v02.5.2** · L11 **v02.7.2** · L12 **v01.7.2** · L13 **v02.6.2** · L14 **v02.8.2** · L15 **v02.6.2** · L16 **v02.5.2** · Bible **v8.58** · Maker **v2.45.1** · Gate v1.6 · Harness v3.0 · pill_sweep v1.0 · book_gates **v1.7 (21 gates)** · going_deeper **v01.1.0** · **web tools (version-lined in-file): timer v1.3.0 · Maker v2.45.1 · tutor v1.0.0 · index v1.3.0**.
