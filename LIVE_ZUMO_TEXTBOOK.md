...
**Date:** August 8, 2026 (Session 133 — **A GENERATED NAME IS NOT A HANDLE.** DJ asked for something three bytes wide: an objective list should not draw a bullet on top of its checkbox. Assigning the existing class `ul-ls-none-3` to the four offending lists silently re-resolved **twelve lessons nobody touched** — L03 `padding-left: 0` to `5px`, L06–L13 the reverse. Reverted, re-authored as inline, and it happened **again**, because `.ul-ls-none` and `.ul-ls-none-3` differ only by a rank-assigned `-N` suffix and adding uses to either SWAPS them. §27.15b twice in one hour, **caught both times by comparing RESOLVED STYLING against a snapshot — no gate saw it and no gate can**, since a swap regenerates perfectly. DJ ruled `css/semantic.css`, which worked first time with ZERO collateral: all 22,142 resolved declaration strings byte-identical. **The selector is an ATTRIBUTE, not a class** — S128's lesson, where `class="mark"` was re-emitted as `.img-fs-0`. Also: the em dash leaves 24 body KEY TERMs, **all 237 back-to-top links become one spelling** after L15/L16's 28 were found rendering flush LEFT, and §1 and §2 get rules and gates — 66 and 67.)
**Status:** ✅ **67 GATES PASS · 237 BACK-TO-TOP LINKS, ONE SPELLING · §1 AND §2 ARE GATED.** **THE ONE TO CARRY: if a construct needs a name that means something, the name lives in the preserved layer and the markup carries an ATTRIBUTE. Never reach for a name `build_css` emitted.** **AND A SECOND, RECORDED NOT FIXED: `build_css` IS NOT IDEMPOTENT ON THIS TREE** — the same sixteen lesson files produce two different stylesheets depending on which sheet you start from, `.ul-ls-none-2` and `.ul-ls-none-3` alternating across runs. §27.13 assumes one fixed point; there are two. **FIVE WRONG COUNTS REACHED DJ AND EVERY ONE MEASURED A PROXY:** `<strong>` presence for *has a readable term* (41, truly **24**), a path substring for *is a figure* (a false **16 of 16** with six lessons still empty), a 400-byte window for *what follows the glossary*, a regex requiring a period for *has a lead-in*, and `start`+`bytes` for a block whose length is measured in the EXPANDED source. Read the specimens before any count leaves the sandbox. **§1 HAD FIVE LESSONS WITH NO FIGURE AND NO PLACEHOLDER** — invisible to `image_audit`, correctly, because nobody had ever declared one was wanted; the worklist rises 14 of 141 to **19 of 146** and that rise is the point. **AND THE BIBLE MOVED: v8.126 seats §2.1 and §2.2 as REAL SECTIONS in the same push as the gates that enforce them (§24.2), corrects §14.1's template filename to `ZUMO_TDP_Template_v3.md` - a name that had pointed at no file on disk - and records both S133 findings: the generated-name swap, and that `build_css` has TWO fixed points where §27.13 assumes one.**

**Versions:** L01 v03.27.0 · L02 v03.20.0 · L03 v03.39.0 · L04 v04.27.0 · L05 v04.27.0 · L06 v04.30.0 · L07 v04.30.0 · L08 v04.29.0 · L09 v05.25.0 · L10 v02.26.0 · L11 v02.28.0 · L12 v01.31.0 · L13 v02.28.0 · L14 v02.32.0 · L15 v02.29.0 · L16 v02.21.0 · going_deeper v01.6.1 — census **40,450** · Bible **v8.126** · BookComponentStandard v01.13.0 · gen_component v1.6.1 · Maker v2.45.4 · **book_gates v1.62** · lesson_inventory v1.3.5 · pill_sweep v1.1 · gate_payload_match v1.7 · build_family_map v1.6.0 · callout_id v1.0 · build_mark_index v1.1.0 · gen_bonus_banner v1.4.1 · gen_part_banners v1.2 · session_versions v1.23.0 · fit_raster_svg v1.2 · flatten_alpha v1.2 · svg_layout_audit v1.20 · site_parity v1.1 · build_css v1.3.0 · image_audit v1.2 · strip_inline v1.2 · build_worklist v1.1 · regex_audit v1.0 · build_palette v1.1 · class_sweep v1.0 · color_index v1.0 · entity_sweep v1.0 · font_stack_sweep v1.3.0 · next_pointer v1.2 · family_tag v1.2.1 · glossary_convert v1.0 · mark_wire v1.0.2 · glyph_scan v1.1 · title_feed v1.0 · Timer v1.3.2 · `ZUMO_Syllabus_WORKING.md` v1.2 · `images/marks/` **41** · `images/icons/` 49 incl. LICENSE. **Verified by fresh clone at `77531bb`.**
