...
**Date:** August 3, 2026 (Session 109 — **THE SESSION'S REAL PRODUCT IS A CHOSEN VISUAL DIRECTION, AND THE RULING UNDERNEATH IT.** DJ: *"I'm not expecting the kids to memorize that burgandy is note, red is warning. I just want the book to be visually appealing and not boring."* **COLOUR IS NOT A CODE** — every callout's label already says WARNING or KEY TERM in words, so families may SHARE colours, the palette can be small, and family count is an authoring question and never a palette question. Half this session was spent optimising against a constraint that did not exist. Ruled: warm earth · six nav groups, five expandable plus an unnumbered Troubleshoot · a vertical left rail on `<details>` with no JavaScript · no section numbers in the nav, numbers stay on the page · bronze `#725637` headings, which is a defect fix because 341 of 814 heading uses are below the 4.5 contrast floor. **This SUPERSEDES the Heritage Blue band ramp** — `BAND_END` survives as the mechanism, the five blues do not. Six INSIGHT blocks were repainted to canon, three of them having borrowed OTHER families' canon paint while wearing INSIGHT's glyph.)
**Status:** ✅ **45/45 GATES PASS · Census 40,025 · Bible v8.98 · three pushes, all verified clean.** **§24.13 is new canon — *re-derive, do not re-read; a list presented in prose is not the list* — and it was broken in the same session it was written.** A 17-family taxonomy was computed correctly in code, hand-typed into chat as an 11-row table with INSIGHT's 60 blocks dropped in the retyping, then rebuilt FROM THE CHAT MESSAGE. Three passes found nothing because all three were re-readings; `assert tot + rem == 1048` caught it in one line. DJ: *"So when I say double check you don't double check?"* The rule then proved itself twice more the same session — bumping the Bible surfaced a THIRD version home nobody knew about, and an md5 script reported a false mismatch because `sed` ate the hash along with the path. Both caught by parser and by printing, never by re-reading.

**Versions:** L01 v03.18.0 · L02 v03.10.2 · L03 v03.23.2 · L04 v04.18.1 · L05 v04.18.1 · L06 v04.22.1 · L07 v04.20.2 · L08 v04.18.1 · L09 v05.15.1 · L10 v02.15.0 · L11 v02.16.0 · L12 v01.18.0 · L13 v02.16.0 · L14 v02.20.0 · L15 v02.16.0 · L16 v02.11.0 · going_deeper v01.2.0 — census **40,025** · Bible **v8.98** · BookComponentStandard v01.12.1 · gen_component v1.6.1 · Maker v2.45.1 · **book_gates v1.39.2** · lesson_inventory v1.2.0 · pill_sweep v1.0 · gate_payload_match v1.6 · build_family_map v1.1.3 · build_mark_index v1.0.2 · gen_bonus_banner v1.3.0 · gen_part_banners v1.0 · session_versions v1.14.1 · fit_raster_svg v1.2 · flatten_alpha v1.2 · svg_layout_audit v1.19 · site_parity v1.1 · build_css v1.2.1 · image_audit v1.1 · strip_inline v1.1 · build_worklist v1.1 · regex_audit v1.0 · font_stack_sweep v1.1.0 · `ZUMO_Syllabus_WORKING.md` v1.0 · `images/marks/` **41** · `images/icons/` 49 incl. LICENSE. **Verified by fresh clone at `fedb9ef`.**
