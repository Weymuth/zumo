...
**Date:** August 4, 2026 (Session 115 — **TWO PREDICATES FOR ONE CONCEPT, AND ONLY ONE OF THEM WAS COUNTED.** "Converted to the four exit blocks" was decided by §25.2 on the string `MENTAL KNOWLEDGE CHECK` and by gate 29 on `id="brain-check-01"`, and **nothing asserted the two agreed**. Measured: mistyping CHECK→CHEK in ONE lesson dropped it out of §25.2 entirely — no four-block check, no retired-name ban, no checkbox/tag parity — and **all 47 gates passed**. Breaking the other predicate failed three gates loudly. §24.8 exactly: if a lesson silently left §25.2's scope, that gate looked identical either way. Closed with one shared `is_converted()` requiring BOTH marks, and gate 29's magic literal replaced by NAMED SETS — `BC_EXEMPT` and `BC_PENDING` — because a count cannot say WHICH lesson moved. **Then L10 became the tenth conversion.**)
**Status:** ✅ **48/48 GATES PASS · THE §25 PREDICATE HOLE IS CLOSED AND L10 IS THE TENTH CONVERSION.** DJ ruling S115: **L14 and L16 are EXEMPT** — competition day and end-of-course, whose §10s carry content the four blocks would displace — and **L10, L11, L12, L13, L15 convert**, with the L14→L15→L16 flow queued as its own question. `book_gates` reaches **v1.44.1** (from v1.43.2) with a **new gate**: the two conversion marks must agree, and the converted SET must equal the ruled set. Control-run four ways — the CHECK→CHEK sabotage that passed all 47 gates now FAILS naming L10 twice; the opposite half fails; a pending lesson converting fails; an exempt lesson converting fails. **L10 CONVERTED, and the scoping is the lesson.** Read block by block per §25.10e rather than grepped: the retired-name sweep found ONE ancestor, reading §10 found THREE. **A hand-rolled slicer cut at the next `<h3>` and returned CUMULATIVE counts — 14/9/4 — where the DOM says 5/5/4**, inflating the authoring estimate by four items before a sibling walk caught it (§24.6c: an audit slicer is a single-use gate and its number is a lead, not a finding). **BC01 has no ancestor at all** (zero pre-§6 reveals), so its five items are authored and §-cited; **BC02 is L10's own nine §2 objectives migrated character-exact** per §25.5, asserted equal; **BC03 migrates all five Check-Your-Understanding questions VERBATIM** — asserted verbatim, not eyeballed — and authors the five answers it never had; **Rate Yourself folds into BC04** as a labelled group per §25.10a. **What You Built stays OUTSIDE the family**: it recaps, it does not check, which is L08's *Record Your Calibration* precedent. Achievability confirmed before BC02 landed — §6 Step 3 already plants the deliberate `error: redefinition` rep, so objective 4 is earnable. **FOUR BASELINES MOVED AND EVERY ONE WAS CONTROLLED BOTH WAYS.** §21 image coverage 225→230, the sole delta being `BrainGear_Incomplete.png` 45→50. §27.11 645 rules / 2,365 declarations, **diffed by SELECTOR rather than by the comment header** — which carries usage counts and makes every rule look changed — showing exactly one selector gone (`.h4-c-4d535f-5`, 2 declarations), zero born, zero surviving rules altered. `build_family_map` reaches **v1.3.3** (from v1.3.2), baseline 1049→1053, **controlled at an identical generator version pre-tree against post-tree: exactly ONE family moves, BRAIN CHECK 36→40, the other 27 byte-identical.** After the moves, deleting one `color: white;` still FAILS, deleting a callout still FAILS, breaking an image ref still FAILS. **A near-miss worth keeping:** a blind first-occurrence replace put the new family baseline into the CHANGELOG line, rewriting S113's history; caught and reverted, and every later edit went through a `count==1` assert. Applied S115: **L10 v02.17.0** (moderate — the page renders differently, so both §5b homes move). Census **40,206**.

**Versions:** L01 v03.19.1 · L02 v03.11.1 · L03 v03.28.0 · L04 v04.19.1 · L05 v04.19.1 · L06 v04.23.1 · L07 v04.22.0 · L08 v04.19.1 · L09 v05.16.1 · L10 v02.17.0 · L11 v02.17.1 · L12 v01.19.1 · L13 v02.17.1 · L14 v02.22.0 · L15 v02.17.1 · L16 v02.12.1 · going_deeper v01.4.1 — census **40,206** · Bible **v8.104** · BookComponentStandard v01.12.1 · gen_component v1.6.1 · Maker v2.45.2 · **book_gates v1.44.1** · lesson_inventory v1.2.0 · pill_sweep v1.1 · gate_payload_match v1.7 · build_family_map v1.3.3 · build_mark_index v1.0.2 · gen_bonus_banner v1.4.1 · gen_part_banners v1.2 · session_versions v1.17.0 · fit_raster_svg v1.2 · flatten_alpha v1.2 · svg_layout_audit v1.20 · site_parity v1.1 · build_css v1.2.1 · image_audit v1.1 · strip_inline v1.1 · build_worklist v1.1 · regex_audit v1.0 · build_palette v1.1 · class_sweep v1.0 · color_index v1.0 · font_stack_sweep v1.2.0 · `ZUMO_Syllabus_WORKING.md` v1.2 · `images/marks/` **41** · `images/icons/` 49 incl. LICENSE. **Verified by fresh clone at `f03c93f`.**
