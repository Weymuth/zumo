...
**Date:** August 14, 2026 (Session 154 — **GATE 73: A FIGURE THE LESSON PRINTS HAS A ROW IN ITS OWN INDEX.** Intake of the 18-document GPT review, 68,123 words, 245 findings indexed and none yet ruled. A seven-finding calibration pass measured GPT at 6 of 7 on repo-decidable claims; the miss was a confident, specific, wrong line count. One of the six became gate 73.)
**Status:** ✅ **S154 AT 73/73 GATES.** Gate 73 closes an invariant nothing held: L01 printed nineteen figure tags and indexed fifteen — GRAPHIC 1.11, GRAPHIC 1.12, IMAGE 1.14 and IMAGE 1.18 were LANDED, captioned, rendering, and absent from their own record; L15 printed an unshot GRAPHIC 15.4 and indexed 15.1–15.3. **Gate 69 could not see it and is not broken** — 69 pins the planned DENOMINATOR (146), a different property, and its name reads broader than its predicate (rule 44). Region located STRUCTURALLY by `id="figures"`, measured present exactly once in all sixteen; rows by `<tr>`, which is what keeps L04's prose note *"[IMAGE 4.1] and [GRAPHIC 4.1] are two different figures"* from reading as an index row. **NO outstanding exemption**: L15's unshot 15.4 was the candidate, but L03's 3.2/3.5/3.6 and L12's 12.1 are equally unshot and ARE indexed — an exemption would have certified the second instance rather than described a convention (rule 20). Controlled three ways from scratch copies: A adds the five rows and 73 goes green at 72/72 others, B deletes one L14 row from that clean state and 73 fires on L14 ALONE, C breaks the anchor on L09 — a lesson SILENT today — and both the anchor report and the coverage arm speak. **STATED BLIND SPOT (rule 78):** it compares PRINTED to INDEXED, so a figure landed with no caption tag and no index row is invisible; nine lessons print fewer than half their indexed figures. §27.11 digest baseline moved — rules and declarations UNCHANGED at 574/2,033, zero selectors added or removed, every declaration block byte-identical, usage rank only; blinding-controlled inside the GENERATED block, where the first attempt failed because it deleted from the hand-authored semantic layer the gate does not hash (rule 59).

**Versions:** L01 v03.28.4 · L02 v03.21.3 · L03 v03.41.1 · L04 v04.29.1 · L05 v04.29.0 · L06 v04.32.1 · L07 v04.31.4 · L08 v04.31.1 · L09 v05.27.0 · L10 v02.29.2 · L11 v02.30.0 · L12 v01.31.3 · L13 v02.29.0 · L14 v02.34.0 · L15 v02.31.2 · L16 v02.24.0 · going_deeper v01.6.1 — census **40,668** · Bible **v8.144** · BookComponentStandard v01.13.0 · gen_component v1.6.1 · Maker v2.50 · **book_gates v1.68.1** · lesson_inventory v1.3.5 · pill_sweep v1.1 · gate_payload_match v1.8.0 · build_family_map v1.6.4 · callout_id v1.0 · keyterm_prefix v1.0.1 · build_mark_index v1.1.0 · gen_bonus_banner v1.4.1 · gen_part_banners v1.2 · session_versions v1.26.0 · fit_raster_svg v1.2 · flatten_alpha v1.2 · svg_layout_audit v1.20 · site_parity v1.1 · build_css v1.3.0 · image_audit v1.2 · strip_inline v1.2 · build_worklist v1.1 · regex_audit v1.0 · byte_audit v1.2 · build_palette v1.1 · class_sweep v1.0 · color_index v1.0 · entity_sweep v1.0 · font_stack_sweep v1.3.0 · next_pointer v1.2 · family_tag v1.2.1 · glossary_convert v1.0 · mark_wire v1.0.2 · glyph_scan v1.1 · title_feed v1.0 · quiz_bank v1.0.1 · Timer v1.3.2 · `ZUMO_Syllabus_WORKING.md` v1.2 · `images/marks/` **41** · `images/icons/` 49 incl. LICENSE. **Verified by fresh clone at `d8e0d8d`.**
