...
**Status:** ✅ **68 GATES PASS · THE THREE §1 HOOK GRAPHICS ARE LIVE · 16 IMAGES OUTSTANDING OF 146.** **THE ONE TO CARRY: a figure is landed in two places, and the tag is the one that counts.** Four gates failed on the first run and every one was legitimate — §21 and §17.3c coverage baselines (three references and three rasters added, bumped in the same edit as the gate asked), §27.16 (five entities I authored in text nodes, swept literal by `entity_sweep`, decoded text byte-identical), and §27.13/§27.11 (the stylesheet regenerated). **§27.11 MOVED BY DIGEST ONLY:** rules and declarations UNCHANGED at 574/2,033, zero born, died or altered — the 122 changed lines are usage-count comments and a rank reorder, `td` overtaking `div` at 796 against 795. **The acceptance test was the RESOLVED STYLING, not the rule count (rule 24): all 22,165 resolved declaration strings byte-identical across the cycle in all sixteen lessons.** Census 40,450 → **40,455**, and the +5 reconciles exactly: L11 +1, L12 +2 for its three-line `<figure>`, L13 +1, plus three index rows. `book_gates` **v1.63.1**.

**Versions:** L01 v03.28.0 · L02 v03.21.0 · L03 v03.40.0 · L04 v04.28.0 · L05 v04.28.0 · L06 v04.31.0 · L07 v04.31.0 · L08 v04.30.0 · L09 v05.26.0 · L10 v02.27.0 · L11 v02.28.1 · L12 v01.31.1 · L13 v02.28.1 · L14 v02.33.0 · L15 v02.30.0 · L16 v02.22.0 · going_deeper v01.6.1 — census **40,455** · Bible **v8.127.1** · BookComponentStandard v01.13.0 · gen_component v1.6.1 · Maker v2.45.4 · **book_gates v1.63.1** · lesson_inventory v1.3.5 · pill_sweep v1.1 · gate_payload_match v1.7 · build_family_map v1.6.0 · callout_id v1.0 · keyterm_prefix v1.0.1 · build_mark_index v1.1.0 · gen_bonus_banner v1.4.1 · gen_part_banners v1.2 · session_versions v1.24.0 · fit_raster_svg v1.2 · flatten_alpha v1.2 · svg_layout_audit v1.20 · site_parity v1.1 · build_css v1.3.0 · image_audit v1.2 · strip_inline v1.2 · build_worklist v1.1 · regex_audit v1.0 · build_palette v1.1 · class_sweep v1.0 · color_index v1.0 · entity_sweep v1.0 · font_stack_sweep v1.3.0 · next_pointer v1.2 · family_tag v1.2.1 · glossary_convert v1.0 · mark_wire v1.0.2 · glyph_scan v1.1 · title_feed v1.0 · Timer v1.3.2 · `ZUMO_Syllabus_WORKING.md` v1.2 · `images/marks/` **41** · `images/icons/` 49 incl. LICENSE. **Verified by fresh clone at `1726c38`.**
