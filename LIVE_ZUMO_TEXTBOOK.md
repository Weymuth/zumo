...
**Date:** July 24, 2026 (Session 67 — spiral-move assessment · trapezoid move (L06 C8 → L07 C7) · L07–L16 marking batch · L08 capstone "The Racing Line").
**Status:** **THE PROGRESSION AUDIT'S FOURTH RULING: THE TRAPEZOID MOVED.** A book-wide challenge-move assessment (now in repo: `ZUMO_SPIRAL_MOVE_ASSESSMENT.md` v1.1, plus `ZUMO_SHELVED_CARDS.md` holding six shelved L12–L14 card specs) found exactly one move that promotes the spiral AND repairs the ramp: **L06 Challenge 8 "Trapezoidal Motion Profile" (Advanced/Deep) relocated to L07 as Challenge 7**, re-homed in the eight-file architecture — declaration in RobotMotion.h, implementation in RobotMotion.cpp (free to call that file's static averageCounts()), test in main.cpp. The card gained a "Builds on:" spiral marker (stars 06 + 03 — the first spiral marker in the book's back half), an architecture-error entry in Common Errors, and a which-file-owns-what solution frame. GRAPHIC 6.11 and its manifest row traveled with it. Maker side was a preload re-point only: the `trapezoidal` kind row moved from the lesson-6 list to the lesson-7 list riding L07's existing `finished` payload — zero payload authoring. **Ramp effect (script-verified): L06 2.62→2.29 · L07 1.83→2.29, both axes now identical 16/7; the L06→L07 crash (−0.79) is eliminated and L05→L06→L07 is monotone (2.20 → 2.29 → 2.29). The visible sag is now L08 (2.00, −0.29) — its fix stays the carried capstone-authoring task.** DJ ruled the L12–L14 job is the ramp (Job B), not the count — so L12–L14 (already the hardest three lessons after L15) were left untouched and the six prose-built card proposals were shelved, recoverable. S67 also corrected an S67-internal arithmetic error the double-check caught (L06-after was mis-stated 2.43; true 2.29 — every mean is now script-computed, never hand-summed). All 14 book gates PASS on the delivered set.

**Versions:** L01 v03.6.4 · L02 v02.13.4 · L03 v03.10.1 · L04 v04.5.3 · L05 v04.5.0 · L06 v04.10.0 · L07 **v04.6.1** · L08 **v04.5.0** · L09 **v05.3.1** · L10 **v02.4.1** · L11 **v02.6.2** · L12 **v01.6.1** · L13 **v02.5.1** · L14 **v02.7.1** · L15 **v02.5.1** · L16 v02.4.0 · Bible v8.49 · Maker **v2.45** · Gate v1.6 · Harness v3.0 · pill_sweep v1.0 · book_gates v1.1 · going_deeper v01.0.0.
