...
**Date:** August 19, 2026 (Session 177 — **THE FIRST PROVE-IT-YOURSELF EXERCISE IN THE BOOK DISPROVED THE BOOK, AND THE DECISIVE EVIDENCE WAS INTERNAL RATHER THAN THE VENDOR'S.** L01 §6 *Break It On Purpose* told the student to switch robot power **OFF**, click Upload and watch it fail. **It succeeds** — Pololu 0J63 §3.8 says a Zumo on USB takes 5 V logic power with the switch off, *useful if you want to upload or test a program without drawing power from the batteries*. **BUT THE PRIMARY SOURCE IS NOT WHAT CONVICTS IT:** the same §6, six thousand characters earlier, carries WARNING 1.46 *Plugged In Is Not Powered On*, and Challenge 11's hint says it a third time. **The lesson stated the correct fact twice and then set an exercise that depends on its negation, inside one section** — a book that contradicts itself needs no external citation to be convicted, only to be read in order. **RULED (DJ, S176) AND APPLIED: UNPLUG THE USB CABLE** — a real upload failure, no file edit, **no persistent state**, where GPT's invalid `board =` id fails at BUILD and puts twelve students in `platformio.ini` on day one. **ALL TEN CONFIRMED L01 FINDINGS SHIPPED IN ONE ARC**, twenty-one edits each asserted `count == 1`, plus one adjacent contradiction found while reading. **TWO HANDOFF CLAIMS DID NOT SURVIVE VERIFICATION AND BOTH WERE CHECKED BEFORE ANYTHING MOVED (§24.6c): L03 WAS NOT EDITED** — its *connected via USB with power ON* prerequisite is TRUE, because Part 2 drives the robot — and L01-12 was smaller than recorded, TIP 1.45 already carrying the Mac form. **AND THE QUIZ BANK WAS RIGHT WHILE THE LESSON WAS WRONG, WHICH IS THE INVERSION WORTH THE INK:** Challenge 4's reveal said *twice as long in each direction* where only the FIRST of two `delay(350)` calls changes, while **`L01_A06` has keyed the correct behaviour all along** and even carries a distractor whose `why` reads *Only the first one changed*. The bank was authored from the payload; the reveal was never corrected. **When a bank and its lesson disagree, neither is automatically the outlier — the PAYLOAD is the artefact both derive from, and it decides.** **THREE BANK ANSWERS WERE KEYED TO CLAIMS THIS SESSION FALSIFIED** (the S165 shape, live), and `L01_A04`'s cable distractor went too, because **a correct edit can turn a fair distractor into an unfair one**. **THE PIN ARC CLOSED IN THE SAME SESSION (§37):** `QUIZ_L02` and `QUIZ_L16` also pin `lesson_01` and their three L01-asserting questions were READ, so both pins were earned rather than bumped. **AND §27.8b's CYCLE WAS NOT OWED, WHICH A SCRATCH-COPY CONTROL ESTABLISHED BEFORE THE TREE WAS TOUCHED:** the stylesheet was regenerated in a COPY and diffed name by name — **574 rules both ends, 2,033 declarations, ZERO names added, dropped or repointed** — so a plain regeneration sufficed and **S168's held-LESSON-STRIP hazard stayed out of the session entirely**. **TEN PROSE DEFECTS SHIPPED PAST 78 GREEN GATES — §16.18 from the content side, again.** Bible **v8.170**, §16.46 NEW and seated with a numbered body.)
**Status:** ✅ **S177 — LESSON 1 IS REWRITTEN AND ITS TEN FINDINGS ARE CLOSED.** **78/78 gates**, `gate_payload_match` **PASS with the census armed**, `quiz_bank` 16 banks at **1,246** questions, `build_css --check` current at 574 rules, `image_audit --check` current, `build_worklist --check` current **after regeneration**, `callout_id` 1127/0, `next_pointer` clean, census **41,009**. **`site_parity` COULD NOT RUN AND MUST RUN TWICE AFTER THIS PUSH (§16.42)** — the tree differs from the published site by design. **`byte_audit` DID NOT RUN AND DID NOT NEED TO** — no payload moved and there was no Maker change; its eight standing controls stand verified as of S175. **ONE lesson, THREE banks, ONE instrument and TWO documents changed.**

**Versions:** L01 v03.31.1 · L02 v03.21.5 · L03 v03.43.2 · L04 v04.29.2 · L05 v04.29.1 · L06 v04.32.4 · L07 v04.31.5 · L08 v04.32.1 · L09 v05.27.4 · L10 v02.30.3 · L11 v02.31.1 · L12 v01.33.1 · L13 v02.35.0 · L14 v02.36.0 · L15 v02.32.0 · L16 v02.28.0 · going_deeper v01.6.1 — census **41,009** · Bible **v8.170** · BookComponentStandard v01.13.0 · gen_component v1.6.1 · Maker v2.62 · **book_gates v1.72.8** · lesson_inventory v1.3.5 · pill_sweep v1.1 · gate_payload_match v1.9.0 · build_family_map v1.6.6.1 · callout_id v1.0 · keyterm_prefix v1.0.1 · build_mark_index v1.1.0 · gen_bonus_banner v1.4.1 · gen_part_banners v1.2 · session_versions v1.30.0 · fit_raster_svg v1.2 · flatten_alpha v1.2 · svg_layout_audit v1.20 · site_parity v1.2 · build_css v1.4.0 · image_audit v1.3 · strip_inline v1.2 · build_worklist v1.2 · regex_audit v1.0 · byte_audit v1.9.1 · build_palette v1.1 · class_sweep v1.0 · color_index v1.0 · entity_sweep v1.0 · font_stack_sweep v1.3.0 · next_pointer v1.2 · family_tag v1.2.1 · glossary_convert v1.0 · mark_wire v1.0.2 · glyph_scan v1.1 · title_feed v1.0 · quiz_bank v1.6.1 · Timer v1.3.2 · harness_setup v1.1 · pio_harness v3.1 · `ZUMO_Syllabus_WORKING.md` v1.3 · `images/marks/` **41** · `images/icons/` 49 incl. LICENSE. **Verified by fresh clone at `6225790`.**
