...
**Date:** August 9, 2026 (Session 140 — **READ -> FIX -> QUIZ, AND THE FIX KEEPS BEING A CONTRADICTION BETWEEN SECTIONS THAT NO INSTRUMENT CAN SEE.** L05's Experiment 3 placed a box at 45° and its hint predicted RIGHT would answer — but §3.4a, written later, states that 19°–72° off each flank is a blind wedge with nothing aimed into it. 45° is 26° past FRONT's edge and 27° short of RIGHT's, almost exactly the middle. The tell was the citation: the hint cites §3.4, not §3.4a, so the experiment predates the section and nobody went back. A student running it would have seen 0 and concluded the hardware was broken — the exact inference §3.4a exists to prevent, four sections earlier. Rewritten to DEMONSTRATE the dead spot, with a second move out to 90° so the card still proves the side detector works. **AND A KEYWORD CAN BE USED, GLOSSED AND NEVER TAUGHT.** `static` appears in L05 §5.11 (retained local, no prose), again in L06's averageCounts() (file scope, no prose), and is only explained in L07 — two different meanings of one word, met twice before anything defines either. Both now teach their own sense and name the other. **AND THE HEADER OF A THING IS NOT THE THING.** Both new quiz banks named question ids that had shifted during drafting: L05's header credited the `static` questions to B33/B34/B58 where they are B26/B27/B28/B53/B59, and claimed a question sat on BRAIN CHECK 03 when none does. Caught only by re-deriving the ids from the file rather than reading the header. **AND A SNAPSHOT YOU HAVE RUN TOOLS IN HIDES ITS OWN DEBRIS**: a root `__pycache__` was invisible against the working snapshot and showed up instantly against a fresh clone.)
**Status:** ✅ **69/69 GATES · L03 AND L05 READ, FIXED AND BANKED · BANKS 2 → 4 OF 12.** **THE ONE TO CARRY: when two sections disagree, read the citations — the older one usually predates the newer, and nothing in the tree can see it.** **L03's last two [CONTENT PLACEHOLDER] blocks are gone**: the brushed-vs-brushless explainer is written into §4.2 as prose, seated after the motor photo so GRAPHIC 3.18 stays with the paragraph it illustrates; the Roomba story was SKIPPED by DJ ruling, because §1 *The Crooked Robot Problem* already carries that thesis 1,150 lines above it. **L05: four findings, all fixed.** Experiment 3 now demonstrates §3.4a's dead spot instead of contradicting it; `static` is taught in both senses across L05 §5.11 and L06's averageCounts(); BRAIN CHECK 03 Q4 asked about `delay()` and answered about duplicated code, and both halves now address `delay()`; Challenge 4's CLOSE_THRESHOLD moved 4 → 5 so its three zones match §3.2's three distance bands exactly — the comment was right and the number was wrong. **ONE FINDING WAS REVERSED BY MEASUREMENT**: L05's BC02 shares zero character-exact lines with its §2 objectives, which looked like a §25.5 violation until all sixteen lessons were measured — **only L06 satisfies §25.5 (6/6)**, every other lesson is 0–4, so it is a book-wide condition and not an L05 defect. **BANKS: L03 v1.0.0 (83 questions) and L05 v1.0.0 (87), both authored AFTER the read and the fixes** — five L05 questions rest on the corrected Experiment 3 geometry and would have been keyed backwards against v04.28.1. L04's bank re-pinned to L03 v03.41.0 (v1.1.1, pin only; its comment header had drifted to v1.0.0 while the YAML key read 1.1.0). **The §27.11 digest moved FOUR times, all usage rank**, rules and declarations unchanged at 574/2,033 every time and all 574 declaration blocks byte-identical. Bible **v8.132** · `book_gates` **v1.64.5** · Maker **v2.45.5**.

**Versions:** L01 v03.28.2 · L02 v03.21.2 · L03 v03.41.0 · L04 v04.29.0 · L05 v04.29.0 · L06 v04.32.0 · L07 v04.31.1 · L08 v04.30.1 · L09 v05.26.1 · L10 v02.27.1 · L11 v02.28.2 · L12 v01.31.2 · L13 v02.28.2 · L14 v02.33.1 · L15 v02.30.1 · L16 v02.22.1 · going_deeper v01.6.1 — census **40,489** · Bible **v8.132** · BookComponentStandard v01.13.0 · gen_component v1.6.1 · Maker v2.45.5 · **book_gates v1.64.5** · lesson_inventory v1.3.5 · pill_sweep v1.1 · gate_payload_match v1.7.1 · build_family_map v1.6.0 · callout_id v1.0 · keyterm_prefix v1.0.1 · build_mark_index v1.1.0 · gen_bonus_banner v1.4.1 · gen_part_banners v1.2 · session_versions v1.24.1 · fit_raster_svg v1.2 · flatten_alpha v1.2 · svg_layout_audit v1.20 · site_parity v1.1 · build_css v1.3.0 · image_audit v1.2 · strip_inline v1.2 · build_worklist v1.1 · regex_audit v1.0 · build_palette v1.1 · class_sweep v1.0 · color_index v1.0 · entity_sweep v1.0 · font_stack_sweep v1.3.0 · next_pointer v1.2 · family_tag v1.2.1 · glossary_convert v1.0 · mark_wire v1.0.2 · glyph_scan v1.1 · title_feed v1.0 · Timer v1.3.2 · `ZUMO_Syllabus_WORKING.md` v1.2 · `images/marks/` **41** · `images/icons/` 49 incl. LICENSE. **Verified by fresh clone at `fc16c2b`.**
