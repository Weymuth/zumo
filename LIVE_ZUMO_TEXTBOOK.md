...
**Versions:** L01 **v03.12.0** · L02 **v03.3.0** · L03 **v03.17.0** · L04 **v04.11.0** · L05 **v04.12.0** · L06 **v04.16.0** · L07 **v04.12.0** · L08 **v04.11.0** · L09 **v05.9.0** · L10 **v02.8.0** · L11 **v02.10.0** · L12 **v01.11.0** · L13 **v02.10.0** · L14 **v02.12.0** · L15 **v02.9.0** · L16 **v02.6.0** · going_deeper **v01.1.1** — **ALL 16 lessons changed in S91** · Bible **v8.78** · **BookComponentStandard v01.7.0** · **gen_component v1.4 (22 checks, ALL PASS)** · Maker **v2.45.1** · book_gates **v1.24 (34 gates, 34/34 PASS)** · pill_sweep v1.0 · lesson_inventory **v1.1.0** · gen_bonus_banner **v1.2** · gen_part_banners v1.0 · Gate v1.6 · Harness v3.0 · `images/icons/` **49 marks + LICENSE (generator input)** · `images/marks/` **41 generated marks, all regenerated S91** · **web tools: timer v1.3.0 · Maker v2.45.1 · tutor v1.1.0 · index v1.3.0**.
