...
**Date:** August 5, 2026 (Session 120 — **THE L14 → L15 → L16 FLOW ITEM IS CLOSED, AND THE RULING IS §3.1: THE BOOK ENDS AT LESSON 16, FOR EVERY READER.** Queued by DJ at S115, unblocked when the conversion arc finished at S119. The seam was measured three ways and the three disagreed: the **code chain is continuous** (L13 24,902 → L14 25,640 → L15 28,034 → L16 starts 28,034), the **narrative is not** (L14 carries a course ending; L15 carried no forward pointer at all), and the **exit blocks alternate** legacy / converted / legacy, which is the S115 exemption's visible cost. **L14 was closing the course two lessons early** — its *What's Next?* offered L15 and L16 as post-competition ***options*** in a three-bullet menu whose third bullet was *"Different competitions: sumo wrestling, maze solving, soccer"*, an after-the-book list sitting in peer position with the capstone. **The byte chain said the opposite:** L16 §4.2 audits *"where YOUR 28,034 bytes are"*, which IS L15's finished build, so L16 hard-requires the lesson L14 called optional. Prose and code disagreed and the prose was wrong. **A SECOND ENDING WAS OFFERED AND DJ RULED IT OUT** — the grid stops Fall at L13 Step 3, so the obvious third fix was a Fall-terminal close in L13, and DJ ruled *"I don't think we need to make the book tell them they are done at 13… if this book is used by others, then 13 won't be the end. It would be 16."* Dropped, not parked. **The corollary is canon: this Bible carries NO calendar canon and must not acquire any** — measured **against the file as it stood before this entry**: `trimester`, `Fall`, `Winter`, `calendar` and `class period` each occurred **zero** times. **They occur now, in this entry and in §3.1, and that is the trap worth recording** — the first draft of this sentence asserted the zero as a present-tense fact about a file the sentence itself had just falsified, and it survived a full gate pass because no gate counts words. A word count was the wrong instrument in any case: §3.1 forbids a scheduling FACT that a lesson depends on, not the vocabulary for discussing the boundary. the term split lives in `ZUMO_Teacher_Daily_Grid_WORKING.md`, which already rules its own mid-L13 break *"a calendar seam, not a book seam."* That separation is exactly what lets an adopter run a different length. **THE SESSION'S DURABLE FINDING IS ABOUT THE GATE THAT CAUGHT THE FIX.** §24's cross-lesson promise gate FAILED the rewrite naming `L14 -> L16: promises ['PID']`, because the new bullets carried no terminal punctuation and *full PID* ran on into the Lesson 16 sentence. **The ORIGINAL bullets had exactly the same run-on** and passed only because the deleted sumo/maze/soccer bullet pushed the distance to the next period past the gate's 110-character window — **a gate satisfied by the geometry of the defect rather than by its absence**, reading identically either way (§24.8 in a new place). Closed by punctuating each bullet as its own sentence, **not** by touching the gate. **Applied S120, both MODERATE** (the pages render differently, so both §5b homes move): L14 **v02.23.0** — *What's Next?* rewritten, the *Final Word* and 🏆 box read and **deliberately left alone**, since a competition send-off at lesson 14 is legitimate and the menu was the defect; L15 **v02.19.0** — gains the `Next:` pointer it had never carried, seated on **L13's live placement** with its two figures checked rather than assumed (28,034 finished, 28,672 ceiling, 638 bytes). **No stylesheet regeneration**: `build_css --check` current at 643 rules, so none of §27.8b's three steps ran and only the two edited lessons differ. Census **40,979**. Bible **v8.109**.)
**Status:** ✅ **49/49 GATES PASS · THE L14 → L15 → L16 FLOW ITEM IS CLOSED.** **§3.1 is new canon** per DJ ruling: no lesson before 16 closes the course, L16 is the capstone for every reader, and where a section's calendar stops is a fact about that calendar rather than about the book. **The Fall-terminal close in L13 was offered and ruled out**, which is what keeps the book adoptable at a different length. Two lessons changed and nothing else — the stylesheet did not move, so the §27.8b sequence never ran. **S121 opens on the forward pointer, which §3.1 assumes and no gate holds:** measured, `<strong>Next:</strong>` exists in exactly three lessons (13, 14, 15) and a *What's Next?* heading in seven (01, 03, 05, 06, 07, 08, 14), overlapping only in L14 — whether every lesson 01–15 must carry one, and which construct is canon, is unruled and ungateable until it is. Also carried: L01's BC02, S116's past-tense question (six sessions now), L10's `<h4>`, and the syllabus/TDP consequence of the L13 stop, which §3.1 rules is a syllabus question and not a book one.

**Versions:** L01 v03.19.2 · L02 v03.11.2 · L03 v03.28.1 · L04 v04.19.2 · L05 v04.19.3 · L06 v04.23.3 · L07 v04.22.2 · L08 v04.19.3 · L09 v05.16.3 · L10 v02.17.1 · L11 v02.18.1 · L12 v01.20.1 · L13 v02.18.0 · L14 v02.23.0 · L15 v02.19.0 · L16 v02.12.1 · going_deeper v01.4.1 — census **40,979** · Bible **v8.109** · BookComponentStandard v01.12.1 · gen_component v1.6.1 · Maker v2.45.2 · **book_gates v1.45** · lesson_inventory v1.2.0 · pill_sweep v1.1 · gate_payload_match v1.7 · build_family_map v1.3.7 · build_mark_index v1.0.2 · gen_bonus_banner v1.4.1 · gen_part_banners v1.2 · session_versions v1.17.0 · fit_raster_svg v1.2 · flatten_alpha v1.2 · svg_layout_audit v1.20 · site_parity v1.1 · build_css v1.2.1 · image_audit v1.1 · strip_inline v1.1 · build_worklist v1.1 · regex_audit v1.0 · build_palette v1.1 · class_sweep v1.0 · color_index v1.0 · font_stack_sweep v1.2.0 · `ZUMO_Syllabus_WORKING.md` v1.2 · `images/marks/` **41** · `images/icons/` 49 incl. LICENSE. **Verified by fresh clone at `PENDING — fill from the push`.**
