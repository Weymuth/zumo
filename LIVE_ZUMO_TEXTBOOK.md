...
**Date:** August 8, 2026 (Session 134 — **THE SHAPE THAT LOOKS LIKE DRIFT MAY BE THE SHAPE THAT IS RIGHT, AND ONLY THE WHOLE POPULATION CAN SAY WHICH.** S133 handed over 22 body KEY TERM blocks in three unruled shapes, and the reading this session opened with - and put to DJ - was that a literal `KEY TERM:` prefix is redundant with the `key` mark, the S129 *"we don't want Note - Note"* shape. **The measurement said the exact opposite.** Across all 1,119 live callouts: NOTE 113/133, CHECKPOINT 102/112, TIP 79/85, DO THIS NOW 55/58, WARNING 67/80, LEARN 38/47, and BRAIN CHECK / THE GOAL / MY PLAN / BUILDS ON at 100%. **KEY TERM stood at 13 of 238 - and those 13 were precisely the blocks about to be stripped**, so the only self-unnaming family in the book was one pass from being made unanimous the wrong way. DJ reversed it on rendered specimens, and the half a count could not have produced is the REGION: the prefix goes in the BODY and stays out of the GLOSSARY, because a banner already reading *Glossary* plus 151 repetitions pushes the term - the thing a reader scans a glossary FOR - off the left edge of every line. 83 blocks converted, the glossary's 151 untouched. **The pin fell 125 to 55 because 70 holds expired by themselves**, gate 62's coverage arm reporting it without being told to. **§24.14d is NEW and has a real section body**, not a changelog-only home.)
**Status:** ✅ **68 GATES PASS · THE BODY KEY TERM NAMES ITS FAMILY, THE GLOSSARY ENTRY DOES NOT · THE PIN IS 55 ROWS.** **THE ONE TO CARRY: a coverage count measures blocks SCANNED, not blocks ASSERTED.** Gate 68's own first draft passed its control run while a fifth id added to `HELD` silently excepted a real conformant block - **a gate that carries exceptions owes a HOLD ARM**, the set pinned by NAME and each held item asserted to still genuinely need holding. That is rule 20 arriving inside the gate written to enforce the ruling. **AND A COROLLARY TO S133's RULE 25: a generated class name is not a handle for READING either** - the converter's first draft located the head by `class="div-fs-105em"` and would have gone silently blind the day that name was reassigned; it walks out from the authored `data-mark` instead. **§27.11 moved by DIGEST ONLY** - rules and declarations unchanged at 574/2,033, zero born, died or altered, the entire sheet delta four lines - and **the acceptance test was the RESOLVED STYLING: all 22,142 pre-existing resolved declaration strings byte-identical** across the restore/regenerate/apply cycle in all sixteen lessons. **UNRULED AND OPENED:** the four held body blocks are a FAMILY question, not a shape one, and two wear another family's canon ground; and the head text colour `#6a1b9a` is 16 blocks in clean strata (L04 5/5, L09 6/6, L10 5/5, 0 of 59 elsewhere) cutting ACROSS the shape classes. **AND THE TRIPLE-CHECK EARNED ITS KEEP:** a count in the v8.127 entry said 19 body blocks carry `id="term-*"`; **18 do**, the nineteenth being L03 `3.44` on `id="glossary-trim"`. §24.13 exactly - the first measurement counted heads carrying ANY id and every later restatement re-read that sentence instead of re-deriving it, so it reached four files including canon. **What caught it was a DIFFERENT METHOD**, a before/after census of every `term-*` id returning **169 before, 169 after, zero lost, zero gained**, which disagreed by exactly one. Corrected; Bible **v8.127.1**, `keyterm_prefix` **v1.0.1**, doc only.

**Versions:** L01 v03.28.0 · L02 v03.21.0 · L03 v03.40.0 · L04 v04.28.0 · L05 v04.28.0 · L06 v04.31.0 · L07 v04.31.0 · L08 v04.30.0 · L09 v05.26.0 · L10 v02.27.0 · L11 v02.28.0 · L12 v01.31.0 · L13 v02.28.0 · L14 v02.33.0 · L15 v02.30.0 · L16 v02.22.0 · going_deeper v01.6.1 — census **40,450** · Bible **v8.127.1** · BookComponentStandard v01.13.0 · gen_component v1.6.1 · Maker v2.45.4 · **book_gates v1.63** · lesson_inventory v1.3.5 · pill_sweep v1.1 · gate_payload_match v1.7 · build_family_map v1.6.0 · callout_id v1.0 · keyterm_prefix v1.0.1 · build_mark_index v1.1.0 · gen_bonus_banner v1.4.1 · gen_part_banners v1.2 · session_versions v1.24.0 · fit_raster_svg v1.2 · flatten_alpha v1.2 · svg_layout_audit v1.20 · site_parity v1.1 · build_css v1.3.0 · image_audit v1.2 · strip_inline v1.2 · build_worklist v1.1 · regex_audit v1.0 · build_palette v1.1 · class_sweep v1.0 · color_index v1.0 · entity_sweep v1.0 · font_stack_sweep v1.3.0 · next_pointer v1.2 · family_tag v1.2.1 · glossary_convert v1.0 · mark_wire v1.0.2 · glyph_scan v1.1 · title_feed v1.0 · Timer v1.3.2 · `ZUMO_Syllabus_WORKING.md` v1.2 · `images/marks/` **41** · `images/icons/` 49 incl. LICENSE. **Verified by fresh clone at `ab8a6ad`.**
