...
**Ungated by design** (§24.6b/§24.6c shape): there is no machine predicate for *closes the course*. The measurable neighbour — whether every lesson 01–15 carries a forward pointer, and in which of the book’s two constructs — is UNRULED and recorded in the queue.
