...
**The retired list only ever caught names somebody thought to retire.** It cannot catch a block whose name was never bad enough to notice. Verified live in the unconverted lessons at S77: **L08 *Check Yourself* · L11 *Skills Check* · L15 and L16 *Wrap-Up*** — none on the list, all invisible to the §25.10b sweep.
...
**THE GATE STILL CANNOT BE WRITTEN.** A BC03 count gate was proposed at S76 close and is *not* adopted: written against the old ceiling it would have failed L02 and L07 on its first run. A floor-of-4 gate is writable today and passes all seven converted lessons — **it has not been written yet.**
