...
- **(a) Header line** — a blue **"🔁 Spiraled skills:"** line at the **top of the challenge card**, naming the precise source **in words** (e.g. "🔁 Spiraled skills: the `if` comparison from L03, the OLED print from L02").
