...
*(§24.14 is the rule behind gate 47 — every callout block resolves to a family. The gate ships
and prints that number; the section does not exist yet. Recorded as a debt at v8.101, S113,
same shape as §21.1's thresholds living only in `book_gates.py`.)*
