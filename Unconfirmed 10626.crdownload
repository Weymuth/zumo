...
**7. Forge Red `#D46554` is the sixth colour.** Danger. §22's `#f14c4c` retires. Warning `#CCA700` and Danger stay **distinct states**. Requires an upstream edit to `InstructionalGraphicStandards` §7 and to the eight RoboLore files that assert a five-colour palette.
