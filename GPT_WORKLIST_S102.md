...
56 findings across 26 files.

- **L01_GRAPHIC_1-10_zumo_hardware_labeled.svg** — font stack leads with "arial-boldmt"; font stack leads with "arialmt"
- **L01_GRAPHIC_1-11_sense_decide_act.svg** — font stack leads with "inter"
- **L01_GRAPHIC_1-12_setup_loop_flowchart.svg** — font stack leads with "consolas"; font stack leads with "segoe ui"
- **L01_GRAPHIC_1-19_playfrequency_anatomy.svg** — font stack leads with "consolas"
- **L02_GRAPHIC_2-04_setup_loop_timeline.svg** — font stack leads with "jetbrains mono"; font stack leads with "inter"
- **L02_GRAPHIC_2-08_memory_ladder.svg** — font stack leads with "inter"
- **L02_GRAPHIC_2-09_folder_structure.svg** — font stack leads with "jetbrains mono"; font stack leads with "inter"
...
- **L02_IMAGE_2-07_ir_sensors_r13.svg** — <image> uses a plain href; photo carries a fully-opaque alpha channel doing nothing; 593,050 B; font stack leads with "inter"
- **L03_GRAPHIC_3-11_command_anatomy.svg** — font stack leads with "consolas"
- **L03_GRAPHIC_3-12_speed_scale.svg** — font stack leads with "consolas"
- **L03_GRAPHIC_3-16_three_turn_types.svg** — font stack leads with "segoe ui"
- **L03_GRAPHIC_3-17_number_line.svg** — font stack leads with "segoe ui"
- **L03_GRAPHIC_3-18_gear_train.svg** — font stack leads with "segoe ui"
- **L04_GRAPHIC_4-04_pin_sharing_map.svg** — font stack leads with "jetbrains mono"; font stack leads with "inter"
- **L04_GRAPHIC_4-05_readline_numberline.svg** — font stack leads with "jetbrains mono"; font stack leads with "inter"
- **L04_GRAPHIC_4-06_for_anatomy.svg** — font stack leads with "consolas"; font stack leads with "consolas"; font stack leads with "segoe ui"
- **L05_GRAPHIC_5-04_for_anatomy.svg** — font stack leads with "consolas"; font stack leads with "consolas"; font stack leads with "segoe ui"
- **L05_GRAPHIC_5-08_three_sensor_array.svg** — <image> uses a plain href; photo carries a fully-opaque alpha channel doing nothing; 1,692,300 B; font stack leads with "inter"
- **L05_GRAPHIC_5-09_five_sensor_array.svg** — <image> uses a plain href; photo carries a fully-opaque alpha channel doing nothing; 1,681,892 B; font stack leads with "inter"
- **L05_GRAPHIC_5-10_jumper_positions.svg** — <image> uses a plain href; <image> uses a plain href; 1,095,810 B; font stack leads with "inter"
- **L06_GRAPHIC_6-02_encoder_magnetic_disc.svg** — font stack leads with "jetbrains mono"; font stack leads with "inter"
- **L06_GRAPHIC_6-03_quadrature_waveforms.svg** — font stack leads with "jetbrains mono"; font stack leads with "inter"
- **L08_GRAPHIC_8-1_bang_bang_oscillation.svg** — font stack leads with "arial-boldmt"; font stack leads with "arial-italicmt"; font stack leads with "arialmt"
- **L11_GRAPHIC_11-02_cliff_arithmetic.svg** — font stack leads with "consolas"; font stack leads with "segoe ui"
- **L16_GRAPHIC_16-03_ab_protocol.svg** — font stack leads with "jetbrains mono"; font stack leads with "inter"
