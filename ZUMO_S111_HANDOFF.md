...
Fresh-clone verified at **`790d5aa`**. Census **40,025**.
Bible **v8.98** · `BookComponentStandard` **v01.12.1** · Maker **v2.45.2** ·
...
Callout)* re-rated five headers — c01/c06/c09 `MEDIUM→EASY`, c10 `HARD→MEDIUM` — **all four
already agreeing with their cards**. **c11 was missed by that sweep**, still reading
`[MEDIUM]` against a card reading `easy`. DJ ruling: *"C11 is easy."* Corrected; the edit
